...
public class LoginUsuario extends javax.swing.JFrame {
    ...
    public LoginUsuario(TelaPrincipal tela,FuncionarioDAO daoFuncionario,UsuarioDAO daoUsuraios,LivroDAO daoLivro, EmprestimoDAO daoEmprestimo, AutorDAO daoAutor){
        this.tela= tela;
    ...
    private void initComponents() {
        ...
        jButton3.setText("Logar como Funcionario");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(textoFuncio))
                .addGap(76, 76, 76)
                .addComponent(buttologin, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButton1)
                .addGap(64, 64, 64))
        );
    ...
    private void buttologinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttologinActionPerformed
        ...
        Usuario userAtual = daoUsuarios.localizar(idConvertido);
        if (userAtual != null) {
            dispose();
            tela.abrirTelaMenuUsuario(tela, daoFuncionario, daoUsuarios, daoLivro, daoEmprestimo, daoAutor);
        } else {
